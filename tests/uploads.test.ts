import fs from 'fs';
import type { ResponseLike } from 'raindrop.io/internal/to-file';
import { toFile } from 'raindrop.io/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('raindrop.io/core/uploads');
    await expect(
